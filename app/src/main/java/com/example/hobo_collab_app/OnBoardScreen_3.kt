...
class OnBoardScreen_3 : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.onboard_screen3)

        val titleText = findViewById<TextView>(R.id.slide_3)
        val descriptionText = findViewById<TextView>(R.id.body3)
